...
rtDW . prcj0bragy [ 0 ] ) , 10 , 0 , 3 } , { ( char_T * ) ( & rtDW .
e3nps1yxro ) , 3 , 0 , 1 } , { ( char_T * ) ( & rtDW . hwccjcyk2m [ 0 ] ) , 8
, 0 , 11 } } ; static DataTypeTransitionTable rtBTransTable = { 6U ,
rtBTransitions } ; static DataTypeTransition rtPTransitions [ ] = { { (
char_T * ) ( & rtP . A [ 0 ] ) , 0 , 0 , 179 } } ; static
