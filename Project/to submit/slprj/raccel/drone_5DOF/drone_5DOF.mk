...
MODEL                   = drone_5DOF
MODULES                 = drone_5DOF.c drone_5DOF_capi.c drone_5DOF_data.c drone_5DOF_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c raccel_main.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c slsa_sim_common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT                 = drone_5DOF.exe
MAKEFILE                = drone_5DOF.mk
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = drone_5DOF_ref.rsp
COMPILER_COMMAND_FILE     = drone_5DOF_comp.rsp
