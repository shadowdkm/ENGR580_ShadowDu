...
"Value" ) , 0 , 2 , 0 } , { 11 , TARGET_STRING ( "drone_5DOF/Random Source1"
) , TARGET_STRING ( "MeanVal" ) , 0 , 1 , 0 } , { 12 , TARGET_STRING (
"drone_5DOF/Random Source1" ) , TARGET_STRING ( "VarianceRTP" ) , 0 , 1 , 0 }
, { 13 , TARGET_STRING ( "drone_5DOF/Step" ) , TARGET_STRING ( "Time" ) , 0 ,
1 , 0 } , { 14 , TARGET_STRING ( "drone_5DOF/Step" ) , TARGET_STRING (
"Before" ) , 0 , 1 , 0 } , { 0 , ( NULL ) , ( NULL ) , 0 , 0 , 0 } } ; static
...
rtModelParameters [ ] = { { 15 , TARGET_STRING ( "A" ) , 0 , 5 , 0 } , { 16 ,
TARGET_STRING ( "B" ) , 0 , 6 , 0 } , { 17 , TARGET_STRING ( "K" ) , 0 , 7 ,
0 } , { 18 , TARGET_STRING ( "stateNoiseGain" ) , 0 , 3 , 0 } , { 19 ,
TARGET_STRING ( "stepVal" ) , 0 , 8 , 0 } , { 20 , TARGET_STRING ( "x0" ) , 0
, 3 , 0 } , { 0 , ( NULL ) , 0 , 0 , 0 } } ;
...
CheckStaticUpperBound_max , & rtP . Constant_Value [ 0 ] , & rtP .
RandomSource1_MeanVal , & rtP . RandomSource1_VarianceRTP , & rtP . Step_Time
, & rtP . Step_Y0 , & rtP . A [ 0 ] , & rtP . B [ 0 ] , & rtP . K [ 0 ] , &
rtP . stateNoiseGain [ 0 ] , & rtP . stepVal [ 0 ] , & rtP . x0 [ 0 ] , } ;
...
9 , rtRootInputs , 0 , rtRootOutputs , 0 } , { rtBlockParameters , 6 ,
rtModelParameters , 6 } , { ( NULL ) , 0 } , { rtDataTypeMap , rtDimensionMap
, rtFixPtMap , rtElementMap , rtSampleTimeMap , rtDimensionArray } , "float"
, { 1876633778U , 710715817U , 2342842469U , 1004280244U } , ( NULL ) , 0 , (
