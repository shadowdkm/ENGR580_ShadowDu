...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . ccu4dpkpbc [ 0 ] ) , 0 , 0 ,
82 } , { ( char_T * ) ( & rtDW . jmq3tsxawc . LoggedData [ 0 ] ) , 11 , 0 ,
12 } , { ( char_T * ) ( & rtDW . jkne1n5eru ) , 6 , 0 , 2 } , { ( char_T * )
( & rtDW . myhykfgvxr ) , 7 , 0 , 3 } , { ( char_T * ) ( & rtDW . crw5jrqanh
) , 10 , 0 , 2 } , { ( char_T * ) ( & rtDW . e2f2zvadqk ) , 3 , 0 , 2 } , { (
char_T * ) ( & rtDW . lw2jdaqrz3 ) , 8 , 0 , 2 } } ; static
DataTypeTransitionTable rtBTransTable = { 7U , rtBTransitions } ; static
DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP . A [ 0 ] )
, 0 , 0 , 397 } } ; static DataTypeTransitionTable rtPTransTable = { 1U ,
rtPTransitions } ;
